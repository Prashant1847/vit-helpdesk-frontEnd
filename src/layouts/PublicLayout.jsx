...
import { FaHome, FaPencilAlt, FaSearch, FaGlobe, FaQuestionCircle, FaEnvelope, FaBullhorn, FaBars } from 'react-icons/fa';
...
const PublicLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/announcements', label: 'Announcements', icon: <FaBullhorn className="icon-announcements" /> },
  ];
